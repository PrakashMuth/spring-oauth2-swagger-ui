...
public class Role extends TableImpl<RoleRecord> {
    ...
    private static final long serialVersionUID = 1953051237;
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.NAME_UN, Indexes.ROLE_PKEY);
    }
    ...
    public List<UniqueKey<RoleRecord>> getKeys() {
        return Arrays.<UniqueKey<RoleRecord>>asList(Keys.ROLE_PKEY, Keys.NAME_UN);
    }
