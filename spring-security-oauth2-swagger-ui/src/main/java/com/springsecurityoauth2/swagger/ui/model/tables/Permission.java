...
public class Permission extends TableImpl<PermissionRecord> {
    ...
    private static final long serialVersionUID = 1915908331;
     ...
     */
    public final TableField<PermissionRecord, String> NAME = createField(DSL.name("name"), org.jooq.impl.SQLDataType.VARCHAR(512).nullable(false), this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.PERMISSION_NAME_UN, Indexes.PERMISSION_PKEY);
    }
    ...
    public List<UniqueKey<PermissionRecord>> getKeys() {
        return Arrays.<UniqueKey<PermissionRecord>>asList(Keys.PERMISSION_PKEY, Keys.PERMISSION_NAME_UN);
    }
