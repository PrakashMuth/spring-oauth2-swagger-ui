...
import com.springsecurityoauth2.swagger.ui.model.tables.records.PermissionRecord;
import com.springsecurityoauth2.swagger.ui.model.tables.records.RolePermissionRecord;
import com.springsecurityoauth2.swagger.ui.model.tables.records.RoleRecord;
import com.springsecurityoauth2.swagger.ui.model.tables.records.UserRecord;
import com.springsecurityoauth2.swagger.ui.model.tables.records.UserRoleRecord;
...
public class Keys {
    ...
    private static class ForeignKeys0 {
        public static final ForeignKey<RolePermissionRecord, RoleRecord> ROLE_PERMISSION__ROLE_ID_FK = Internal.createForeignKey(com.springsecurityoauth2.swagger.ui.model.Keys.ROLE_PKEY, RolePermission.ROLE_PERMISSION, "role_permission__role_id_fk", RolePermission.ROLE_PERMISSION.ROLE_ID);
        public static final ForeignKey<RolePermissionRecord, PermissionRecord> ROLE_PERMISSION__PERMISSION_ID_FK = Internal.createForeignKey(com.springsecurityoauth2.swagger.ui.model.Keys.PERMISSION_PKEY, RolePermission.ROLE_PERMISSION, "role_permission__permission_id_fk", RolePermission.ROLE_PERMISSION.PERMISSION_ID);
        public static final ForeignKey<UserRoleRecord, RoleRecord> USER_ROLE__ROLE_ID_FK = Internal.createForeignKey(com.springsecurityoauth2.swagger.ui.model.Keys.ROLE_PKEY, UserRole.USER_ROLE, "user_role__role_id_fk", UserRole.USER_ROLE.USER_ID);
        public static final ForeignKey<UserRoleRecord, UserRecord> USER_ROLE__USER_ID_FK = Internal.createForeignKey(com.springsecurityoauth2.swagger.ui.model.Keys.USER_PKEY, UserRole.USER_ROLE, "user_role__user_id_fk", UserRole.USER_ROLE.USER_ID);
    }
}
