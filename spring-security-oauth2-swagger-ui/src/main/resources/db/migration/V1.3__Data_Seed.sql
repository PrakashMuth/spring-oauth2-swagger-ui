...
VALUES ('OauthApp', '', '$2a$11$7WYpPH3Xo7H3KoailgWpcuuS0gAyH8xk9VKEsgRgOXk43wNiA9vFu', 'webclient,mobileclient',
        'authorization_code',
        'http://localhost:8080/login,http://localhost:3000/login,https://getpostman.com/oauth2/callback,http://localhost:9091/auth/webjars/springfox-swagger-ui/oauth2-redirect.html', '', NULL,
        NULL, '{}', 'true');
/**
USER DETAILS SEAD
 */
